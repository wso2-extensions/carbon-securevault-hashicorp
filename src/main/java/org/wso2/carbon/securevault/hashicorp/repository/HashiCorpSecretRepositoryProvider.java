...
/**
 * HashiCorp Secret Repository Provider.
 */
public class HashiCorpSecretRepositoryProvider implements SecretRepositoryProvider {
    ...
    public SecretRepository getSecretRepository(IdentityKeyStoreWrapper identityKeyStoreWrapper,
        ...
        return new HashiCorpSecretRepository(identityKeyStoreWrapper, trustKeyStoreWrapper);
    }
}
